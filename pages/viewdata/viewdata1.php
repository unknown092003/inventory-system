    ...
    <div class="rtp_table">
        <table>
            ...
            if ($result && $result->num_rows > 0) {
                ...
                echo "<tr><td colspan='15'>No inventory items found</td></tr>";
            }
    ...
    <script>
        ...
        function applyFilters() {
            ...
            for (let i = 0; i < rows.length; i++) {
                ...
                const rowData = {
                    description: row.cells[3].textContent.toLowerCase(),
                    acquisitionDate: row.cells[0].textContent,
                ...
                if (valueFilter !== 'all') {
                    if (valueFilter === 'high') {
                        matchesValue = rowData.amount >= 5000;
                    } else if (valueFilter === 'low') {
                        matchesValue = rowData.amount > 0 && rowData.amount < 5000;
                    }
                }
        ...
        function resetFilters() {
            ...
            // Show all rows except the total row
            const rows = document.querySelectorAll('.rtp_table tbody tr:not(:last-child)');
            for (let i = 0; i < rows.length; i++) {
        ...
        function copyTableToClipboard() {
            const table = document.querySelector('.rtp_table');
